...
def func_df() -> pl.DataFrame:
    """Fixture for rfunctional dataframe."""
    return _df(_func_row("01", "baseline"))


@pytest.fixture
def tpl_df() -> pl.DataFrame:
    """Fixture for tempalte dataframe."""
