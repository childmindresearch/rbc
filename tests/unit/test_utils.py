...
class TestRename:
    ...
    def test_rename_successful(self, test_file: pl.Path) -> None:
        ...
        assert (
            new_path.exists() and new_path.is_file() and new_path.name == "renamed.txt"
        )
    ...
    def test_str_input(self, test_file: pl.Path) -> None:
        ...
        assert isinstance(new_path, pl.Path) and new_path.exists()
    ...
    def test_new_path_dir_ignored(self, test_file: pl.Path) -> None:
        ...
        assert new_path.name == "renamed.txt" and new_path.parent == test_file.parent
