...
_CASES: list[tuple[str, np.ndarray, np.ndarray]] = [
    ...
    (
        ...
        np.array([
            1, 0, 0,
            0, 0.9999988800631344, -0.0014559998253717492,
            0, 0.0014559998253717492, 0.9999988800631344,
            -0.00681799999999555, -0.086711641553336, -0.03481360734485861,
        ]),
    ),
    (
        "MAT_0100",
        ...
        np.array([
            0.9999997243744843, 0.0000011964756347597939, -0.0005249987035247431,
            1.9647810423647357e-7, 0.9999978061484665, 0.002279001734066553,
            0.0005250009825259522, -0.002279001209066274, 0.9999975305233202,
            -0.007576547509401621, 0.09542788142147174, 0.1504767739889843,
        ]),
    ),
    (
        "MAT_0180",
        ...
        np.array([
            0.9999991792056033, -0.0007569442774028026, 0.0004975654192044786,
            0.00075605396377283, 0.9999978328881628, 0.0018963769548377889,
            -0.0004994340684278406, -0.001895622724151258, 0.9999981566780283,
            0.015727160807514906, 0.13819236145373281, 0.16328331032126187,
        ]),
    ),
]
